...
from backend.services.saved_card_service       import SavedCardService
...
class AppContext:
    ...
    def __init__(self, db_path: Path):
        ...
        self.saved_card_repo = SavedCardRepository(conn)
        ...
        self.saved_card_service = SavedCardService(self.saved_card_repo)
